    ...
    <section>
        <div class="container-fluid">
            <header>
                <div class="row">
                    <div class="col-md-7">
                        <h2 class="h3 display">Notifications</h2>
                    </div>
                    <div class="col-md-5">
                        <a href="{{route('admin.new_notif')}}" class="btn btn-primary pull-right rounded-pill">Send new notification</a>
                    </div>
                </div>
            </header>
            <div class="card">
                                ...
                                @if(isset($list) && !empty($list))
                                    @foreach($list as $key => $l)
                                        <tr>
                                            ...
                                            <td width="10%">{!! $l->message !!}</td>
                                            <td width="10%">{{ $l->created_at->format('d-m-Y') }}</td>
                                            {{-- <!-- <td width="10%">
